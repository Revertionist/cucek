  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white mt-24">
      ...
      <div className="flex-grow bg-gray-100">
        ...
        >
          <div className="max-w-4xl text-center space-y-6">
            <h2 className="text-4xl font-bold text-gray-800">Head of Department</h2>
      ...
      <nav className="fixed bottom-0 w-full bg-white shadow-lg p-4 z-10">
